...
public class GenericMethods {
	...
	public void additionOfTravelers(String elementName, String pageName,String recordId) {
		WebElement element = getElement(elementName, pageName);
		String setText= dataMap.get(pageName+recordId+elementName);
		int increment=Integer.parseInt(setText);
		while(increment!=0)
		{
			element.click();
			log.info("Clicked Page (" +pageName +") "+ "Element ("+elementName+")");
	...
	/*** implicit wait for particular element **/
